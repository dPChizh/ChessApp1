...
public abstract  class Move {
    ...
    public static class MoveFactory{
        ...
        public static Move createMove(final Board board, final int currentCoordinate, final int destinationCoordiante){

            for(final Move move : board.getAllLegalMoves()){
                if(move.getCurrentCoordinate() == currentCoordinate &&
                        move.getDestinationCoordinate() == destinationCoordiante) {
                    return move;
                }
            }
            return NULL_MOVE;
